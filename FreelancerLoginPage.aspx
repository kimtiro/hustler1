<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FreelancerLoginPage.aspx.cs" Inherits="hustler1.FreelancerRegistrationPage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="loginDetails" style="margin-top:7.6em; margin-left: 14em; height: 385px; padding-left: 1em;">
            <div class="labelbkg" style=" height: 25px; background-color:#246DF8; margin-bottom: 2em; padding:10px;">
                <asp:Label ID="Label1" runat="server" Text="Freelancer Login Form" ForeColor="White" Font-Bold="True"></asp:Label>
                <br />
                <br />
                <br />
                <br />
